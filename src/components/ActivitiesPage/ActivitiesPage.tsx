...
const ActivitiesPage = () => {
    ...
    return (
        <Box height='100vh' overflow='hidden' padding={2} display='flex' justifyContent="center" gap={3}>
            <Box width="50%" height="100%" display="flex" alignItems="center">
                <Card sx={{width: "100%", height: "100%"}}>
                    <CardContent sx={{width: "100%", height: "100%"}}>
                        <Box display="flex" flexDirection="column" justifyContent="space-between" height="100%" width="100%" gap={2}>
                            ...
                            <Box gap={2} sx={{alignItems: "flex-start", width: "100%", height: "65%"}}>
                                <Card sx={{
                                    width: "100%",
                                    height: '100%',
                                    borderRadius: 2,
